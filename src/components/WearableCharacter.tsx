...
export function WearableCharacter({brand,lod='full',labelled=false,look=brandWearable(brand)}:{brand:Brand;lod?:LOD;labelled?:boolean;look?:ReturnType<typeof brandWearable>}) {
