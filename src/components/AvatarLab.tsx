...
export default function AvatarLab(){
  ...
  return <div className="flow-shell avatar-lab"><header className="flow-header"><a className="flow-logo" href="/"><img src="/vi/mark-black.svg" alt=""/>Brand Relations</a></header><main>
