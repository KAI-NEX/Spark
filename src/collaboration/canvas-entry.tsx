...
import ColliderApp from '../../integrations/collider/brand-collider-skills-design/web/App';
import '../../integrations/collider/brand-collider-skills-design/web/styles.css';
import '../../integrations/collider/brand-collider-skills-design/web/panels.css';
import '../../integrations/collider/brand-collider-skills-design/web/brand-vi.css';
