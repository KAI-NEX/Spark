...
import { createHttpServer } from '../integrations/collider/brand-collider-skills-design/src/server/index';
import { ProductionRepository } from '../integrations/collider/brand-collider-skills-design/src/server/production';
import { RuntimeError } from '../integrations/collider/brand-collider-skills-design/src/server/text-provider';
import type { ColliderRuntime } from '../integrations/collider/brand-collider-skills-design/src/server/runtime';
...
export class RelationsProductionRepository extends ProductionRepository {
  constructor(private store: ProjectStore) { super(resolve('integrations/collider/outputs/manner-hok-20260905')); }
